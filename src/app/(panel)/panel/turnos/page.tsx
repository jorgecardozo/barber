...
import { TurnosTable } from "@/widgets/turnos/ui/TurnosTable";
import type { TurnoRow } from "@/entities/appointment/model/turno";
...
export default async function TurnosPage() {
  ...
  return (
    <main className="flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-x-clip px-4 py-6 sm:px-6 lg:px-8">
      <TurnosTable
        rows={rows}
